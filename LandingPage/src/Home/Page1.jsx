...
const featuresCN = [
  {
    title: "Boost Your Concentration",
    content: "We help you to increase your concentration",
  ...
  },
  {
    ...
    content: "Our Services can be used through API call",
    src: "https://gw.alipayobjects.com/zos/rmsportal/RpJIQitGbSCHwLMimybX.svg",
    color: "#1890FF",
    shadowColor: "rgba(24,144,255,.12)",
  },
  {
    title: "Multi-Featured Dashboard",
    content: "Get some amazing features to boost your concentration",
  ...
  {
    title: "File Accesser",
    content: "Access your videos,ppt and other files",
  ...
  },
  {
    ...
    content: "Get same user experience on your mobile phones",
  ...
  {
    title: "Play Quiz",
    content: "Answer some interesting mind testing questions",
    ...
    return (
      <div className="home-page page1">
        <div className="home-page-wrapper" id="page1-wrapper">
          ...
          <h2>
            What can <span>My Companion</span> do for you{" "}
          </h2>
